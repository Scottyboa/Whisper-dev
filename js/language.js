...
Au final, ce projet est le fruit de l'initiative d'un médecin souhaitant offrir un outil juste et abordable à ses collègues. Si cette plateforme aide d'autres professionnels à éviter de payer trop cher pour un service qui devrait être accessible, alors c'est une réussite.`
  ...
  it: {
    ...
    guideButton: "Guida API",
    securityButton: "Sicurezza",
    aboutButton: "Informazioni",
    adRevenueMessage: "Poiché questo sito è gratuito e si basa esclusivamente sui ricavi pubblicitari, accetta gli annunci personalizzati per supportare il servizio.",
    securityModalHeading: "Informazioni sulla Sicurezza",
    securityModalText: `La privacy e la sicurezza delle informazioni dei pazienti sono priorità assolute. Per garantire che i dati rimangano confidenziali:<br><br>
- <strong>Crittografia dei dati:</strong> Tutti i dati elaborati dal sistema sono protetti con metodi di crittografia conformi agli standard del settore. Trascrizioni e note sono collegate esclusivamente alla tua chiave API personale crittografata e al dispositivo utilizzato, assicurando che solo tu abbia accesso ai contenuti generati.<br><br>
- <strong>Cancellazione automatica:</strong> Una volta generata una trascrizione o una nota e visualizzata sullo schermo, essa viene cancellata automaticamente e in modo irreversibile dai server entro 2 minuti.<br><br>
- <strong>Protezione da accessi non autorizzati:</strong> Anche in un caso estremamente improbabile di accesso non autorizzato alla tua chiave API, i dati rimangono crittografati e protetti da marcatori specifici del dispositivo, rendendo le informazioni inaccessibili.<br><br>
...
Please click "Functions" to return to the main interface.`
  ...
  no: {
    ...
    guideText: `Velkommen til Whisper Transkripsjonsverktøy. Denne applikasjonen lar medisinske fagpersoner, terapeuter og andre utøvere ta opp og transkribere konsultasjoner, samt generere profesjonelle notater ved hjelp av en AI-drevet notatgenerator.<br><br>
<strong>Slik bruker du verktøyet:</strong>
<ul>
  <li><strong>Opptak:</strong> Klikk på "Start opptak" for å starte opptaket. Lydopptak fanges via MediaStreamTrackProcessor (med WebCodecs) og akkumuleres i opptil 40 sekunder før de pakkes som en komplett WAV-fil.</li>
  <li><strong>Fullføring:</strong> Etter at du klikker "Stopp/Fullfør", avsluttes opptaket. En 2-sekunders sluttfase samler opp eventuell gjenværende lyd før den endelige delen behandles. Fullføringstimeren tikker til hele transkripsjonen er mottatt.</li>
...
Klikk på "Funksjoner" for å gå tilbake til hovedskjermen.`
  ...
  sv: {
    ...
    guideText: `Välkommen till Whisper Transkriberingsverktyget. Denna applikation låter medicinska proffs, terapeuter och andra praktiker spela in och transkribera konsultationer, samt generera professionella anteckningar med hjälp av en AI-driven anteckningsgenerator.<br><br>
...
Klicka på "Funktioner" för att återgå till huvudgränssnittet.`
  ...
  de: {
    ...
    guideText: `Willkommen beim Whisper Transkriptionswerkzeug. Diese Anwendung ermöglicht es medizinischen Fachkräften, Therapeuten und anderen Praktikern, Konsultationen aufzunehmen und zu transkribieren sowie professionelle Notizen mit einem KI-gestützten Notizgenerator zu erstellen.<br><br>
...
<ul>
  ...
  <li><strong>Abschluss:</strong> Nach dem Klicken auf "Stoppen/Abschließen" wird die Aufnahme gestoppt. Eine letzte 2-Sekunden-Aufnahme sammelt verbleibende Töne, bevor der endgültige Teil verarbeitet wird. Der Abschlusstimer läuft, bis das vollständige Transkript vorliegt.</li>
